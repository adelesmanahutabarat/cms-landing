        ...
        <div class="row mt-4">
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="text-center">
                    <!-- <a href="{{url("frontend.$module_name.show", [encode_id($$module_name_singular->id), $$module_name_singular->slug])}}" class="btn btn-success" target="_blank"><i class="fas fa-link"></i> Public View</a> -->
                </div>
                <hr>
