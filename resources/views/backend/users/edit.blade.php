    ...
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="form-group row">
                    {{ html()->label('PIC')->class('col-5 col-sm-2 form-control-label')->for('pic') }}
                    <div class="col-6 col-sm-10">
                        <ul class="list-unstyled">
                            <li>
                            <a href="{{ route("backend.pics.index", $user->id) }}"
                            class="btn btn-outline-primary btn-sm"><i class="fas fa-music"></i> Landing</a>
                            </li>
                        </ul>
                    </div>
                </div>
