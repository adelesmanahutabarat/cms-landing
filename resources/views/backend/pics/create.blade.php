...
<x-backend-breadcrumbs>
    <x-backend-breadcrumb-item route='{{route("backend.$module_name.index", $user->id)}}' icon='{{ $module_icon }}'>
        {{ $module_title }}
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->form('PATCH', route("backend.$module_name.store", $user->id))->class('form-horizontal')->open() }}
                {{ csrf_field() }}
