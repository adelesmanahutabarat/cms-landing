...
class UserController extends Controller
{
    ...
    public function profile(Request $request, $id)
    {
        ...
        return view("backend.$module_name.profile", compact('module_name', 'module_name_singular', "$module_name_singular", 'module_icon', 'module_action', 'module_title', 'userprofile','link'));
    }
    ...
    public function profileEdit($id)
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'userprofile',"link")
        );
    }
