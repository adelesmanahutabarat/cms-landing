    ...
    */
    ...
    public function index_data()
    {
        ...
        if(Auth::user()->hasRole('super admin')){
            $$module_name = $module_model::select('id', 'name', 'category_name', 'landing', 'status', 'updated_at', 'published_at', 'is_featured');
        }else{
            $$module_name = $module_model::select('id', 'name', 'category_name', 'landing', 'status', 'updated_at', 'published_at', 'is_featured')->whereIn('landing', $channels);
        }
    ...
    public function create()
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_icon', 'module_action', 'module_name_singular', 'categories', 'landings')
        );
    }
...
/**
    ...
    public function edit($id)
    {
        ...
        return view(
            ...
            compact('categories', 'module_title', 'module_name', 'module_icon', 'module_name_singular', 'module_action', "$module_name_singular", 'landings')
        );
    }
